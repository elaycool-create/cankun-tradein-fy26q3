...
<div class="container">
  ...
  <div class="card" id="bonus-unlocked-card" style="display:none">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px">
      <div style="display:flex;gap:18px;flex-wrap:wrap;font-size:12px;padding:10px 14px;background:#fff8e6;border-radius:10px;border-left:3px solid var(--orange);flex:1;margin-right:10px">
      ...
      <button onclick="lockBonus()" style="padding:6px 14px;border:1px solid var(--border);border-radius:20px;background:#fff;font-size:12px;cursor:pointer;color:var(--sub);white-space:nowrap">🔒 鎖定</button>
    </div>
  ...
  <div class="card">
    ...
    <div style="display:flex;gap:18px;flex-wrap:wrap;font-size:12px;margin-bottom:14px;padding:10px 14px;background:#f9f9fb;border-radius:10px">
